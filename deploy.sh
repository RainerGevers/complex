...
kubectl set image deployments/client-deployment server=rainerza/multi-client:$SHA
kubectl set image deployments/worker-deployment server=rainerza/multi-worker:$SHA